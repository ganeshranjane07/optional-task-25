...
parent = st.number_input("Parental Involvement", 0, 5, 2)
resources = st.number_input("Access to Resources", 0, 5, 2)
previous = st.number_input("Previous Scores", 0, 100, 70)
motivation = st.number_input("Motivation Level", 0, 5, 2)
internet = st.number_input("Internet Access", 0, 1, 1)
tutoring = st.number_input("Tutoring Sessions", 0, 20, 2)
income = st.number_input("Family Income", 0, 5, 2)
teacher = st.number_input("Teacher Quality", 0, 5, 2)
school = st.number_input("School Type", 0, 2, 1)
peer = st.number_input("Peer Influence", 0, 5, 2)
